<script>
    ...
    async function loadSpaceIntegration() {
        try {
            ...
            const resSpace = await fetch('https://space-launches-8cix.onrender.com/api/v2/space-launches');
    ...
    async function loadSpiceIntegration() {
        try {
            ...
            commonYears.sort((a, b) => a - b).forEach((year) => {
...
<main>
    ...
    <section class="chart-section">
        <h3 class="chart-subtitle">Integración: IDH vs Lanzamientos Globales por Año (Highchart + bar)</h3>
