## SOS2526-26
[![Known Vulnerabilities](https://snyk.io/test/github/gti-sos/SOS2526-26/badge.svg?targetFile=src/front/package.json)](https://snyk.io/test/github/gti-sos/SOS2526-26?targetFile=src/front/package.json)
...
A continuación se detallan las fuentes de datos externas utilizadas en este proyecto:

| Recurso | Descripción | Fuente |
| :--- | :--- | :--- |
| **FIFA World Ranking** | Clasificación mundial masculina de selecciones. | [Ver Fuente](https://inside.fifa.com/es/fifa-world-ranking/men) |
| **Human Development Index** | Datos del Índice de Desarrollo Humano (UNDP). | [Ver Fuente](https://hdr.undp.org/data-center/human-development-index#/indicies/HDI) |
| **Market Value (National Teams)** | Valor de mercado de selecciones nacionales. | [Ver Fuente](https://www.transfermarkt.es/vereins-statistik/wertvollstenationalmannschaften/marktwertetop) |
...
- **APIs**: 
  ...
  - https://sos2526-26.onrender.com/api/v2/fifa-squad-value-per-years/docs (developed by Ricardo Fernandez Rodríguez-Navas)
